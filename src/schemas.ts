...
export const WebhookInboxDtoSchema = schemas.WebhookInboxDto
export const WebhookEventDtoSchema = schemas.WebhookEventDto
export const EmailDomainDtoSchema = schemas.EmailDomainDto
export const EmailMessageDtoSchema = schemas.EmailMessageDto
export const SignedDownloadSchema = schemas.SignedDownload
export const InjectEmailMessageResponseSchema = schemas.InjectEmailMessageResponse
export const InboundOtpCodeSchema = schemas.InboundOtpCode
export const InboundEmailLinkSchema = schemas.InboundEmailLink
export const InboundEmailAttachmentSchema = schemas.InboundEmailAttachment
...
export const CreateWebhookInboxRequestSchema = schemas.CreateWebhookInboxRequest
export const UpdateWebhookInboxRequestSchema = schemas.UpdateWebhookInboxRequest
export const CreateEmailDomainRequestSchema = schemas.CreateEmailDomainRequest
export const InjectEmailMessageRequestSchema = schemas.InjectEmailMessageRequest
export const UpdateEmailDomainRequestSchema = schemas.UpdateEmailDomainRequest
...
export const CreateStatusPageMaintenanceRequestSchema = schemas.CreateStatusPageMaintenanceRequest
